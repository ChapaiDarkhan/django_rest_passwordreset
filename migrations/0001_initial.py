# Generated by Django 3.2.15 on 2023-01-31 12:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='password_reset_tokens', to='places.user', verbose_name='The User which is associated to this password reset token')),
            ],
            options={
